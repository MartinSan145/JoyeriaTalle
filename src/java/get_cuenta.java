 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/get_cuenta"})
public class get_cuenta extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    out.println("</td>");
                    out.println("<td>");
                    out.println(rs.getString("fecha_emision"));
                    out.println("</td>");
                    out.println("<td>");
                  ...
                  out.println("<a href='.jsp?id="+rs.getString("idfactura_v")  +"'<button class='btn btn-lg btn-primary btn-block' type=\"submit\">Cobrar</button></a>");
                     out.println("</td>");
                    out.println("</tr>");
                }
            } catch (ClassNotFoundException | SQLException ex) {
                Logger.getLogger(get_cuenta.class.getName()).log(Level.SEVERE, null, ex);
