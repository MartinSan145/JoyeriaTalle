 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/tablafacturas"})
public class tablafacturas extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    out.println("<td>");
                    out.println(rs.getString("timbrado"));
                    out.println("</td>");
                ...
                //  out.println("<input  type=\"submit\" name=\"btconfirma\" value=\"idfactura_v\" href=cobros.jsp>");
                    out.println("<a href='Imprimir.jsp?condicion=ventas&nombre=ventas&codigo="+rs.getString("idfactura_v")  +"'<button class='btn btn-lg btn-primary btn-block' type=\"submit\">IMPRIMIR</button></a>");
                    out.println("</td>");
