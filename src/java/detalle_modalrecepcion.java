 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/detalle_modalrecepcion"})
public class detalle_modalrecepcion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(detalle_modalrecepcion.class.getName()).log(Level.SEVERE, null, ex);
