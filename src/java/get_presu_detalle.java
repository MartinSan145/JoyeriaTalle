 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/get_presu_detalle"})
public class get_presu_detalle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(get_presu_detalle.class.getName()).log(Level.SEVERE, null, ex);
