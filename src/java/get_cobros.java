 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/get_cobros"})
public class get_cobros extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    out.println("</td>");
                    out.println("<td>");
                    out.println(rs.getString("cobro_efectivo"));
                    out.println("</td>");
                    ...
                    out.println("</td>");
                     ...
                     out.println("<td>");
                    out.println("<button type=\"button\" class=\"btn btn-primary btn-xs\" data-toggle=\"modal\" data-target=\"#exampleModal\">\n" +
"  Launch demo modal\n" +
"</button>");
                    out.println("</td>");
