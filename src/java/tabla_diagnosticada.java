 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/tabla_diagnosticada"})
public class tabla_diagnosticada extends HttpServlet {
            ...
            try {
                ...
                while(rs.next()){
                   ...
                   out.println("<tr onclick=\"recupera_datos($(this));\">");
                    ...
                    out.println("</td>");
                     out.println("<td >");
                    out.println(rs.getString("presu_fecha"));
                    out.println("</td>");
                     out.println("<td >");
                    out.println(rs.getString("ordendiagnostico"));
                    out.println("</td>");
                     out.println("<td >");
                ...
                Logger.getLogger(tabla_diagnosticada.class.getName()).log(Level.SEVERE, null, ex);
