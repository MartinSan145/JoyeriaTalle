 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/get_facturascobradas"})
public class get_facturascobradas extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    out.println("</td>");
                    out.println("<td>");
                    out.println(rs.getString("monto"));
                    out.println("</td>");
                    out.println("<td>");
                    out.println(rs.getString("monto_pagado"));
                    out.println("</td>");
                ...
                Logger.getLogger(get_facturascobradas.class.getName()).log(Level.SEVERE, null, ex);
