 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/get_proveedores"})
public class get_proveedores extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    out.println(rs.getString("idnacionalidad"));
                    out.println("</td>");
                ...
                Logger.getLogger(get_proveedores.class.getName()).log(Level.SEVERE, null, ex);
