 ...
 * @author martin
 */
@WebServlet(urlPatterns = {"/detalle_recepcion"})
public class detalle_recepcion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(detalle_recepcion.class.getName()).log(Level.SEVERE, null, ex);
