 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/detalle_ordencompra"})
public class detalle_ordencompra extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(detalle_ordencompra.class.getName()).log(Level.SEVERE, null, ex);
