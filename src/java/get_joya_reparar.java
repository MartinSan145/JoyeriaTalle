 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/get_joya_reparar"})
public class get_joya_reparar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(get_joya_reparar.class.getName()).log(Level.SEVERE, null, ex);
