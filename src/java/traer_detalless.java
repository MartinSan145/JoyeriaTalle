 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/traer_detalless"})
public class traer_detalless extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(traer_detalless.class.getName()).log(Level.SEVERE, null, ex);
