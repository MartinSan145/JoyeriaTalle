 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/traer_cobross"})
public class traer_cobross extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(traer_cobross.class.getName()).log(Level.SEVERE, null, ex);
