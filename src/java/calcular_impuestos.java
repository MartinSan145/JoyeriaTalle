 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/calcular_impuestos"})
public class calcular_impuestos extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    out.println("</td>");
                    out.println("<td>");
                    out.println(rs.getString("exe"));
                    out.println("</td>");
                    out.println("<td>");
                    out.println(rs.getString("gra5"));
                    out.println("</td>");
                    out.println("<td>");
                    out.println(rs.getString("gra10"));
                    out.println("</td>");
                ...
                Logger.getLogger(traer_detallesservicio.class.getName()).log(Level.SEVERE, null, ex);
