 ...
 * @author JUAN
 */
@WebServlet(urlPatterns = {"/get_diagnostico"})
public class get_diagnostico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(get_diagnostico.class.getName()).log(Level.SEVERE, null, ex);
