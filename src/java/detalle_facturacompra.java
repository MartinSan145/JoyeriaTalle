 ...
 * @author Martin
 */
@WebServlet(urlPatterns = {"/detalle_facturacompra"})
public class detalle_facturacompra extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    out.println("<td>");
                    out.println("Gs. "+format.format(gravada));
                    out.println("</td>");
                ...
                Logger.getLogger(detalle_facturacompra.class.getName()).log(Level.SEVERE, null, ex);
