                ...
                <div class="col-md-12">
                    ...
                    <form id="formulario" class="form-horizontal" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" name="txtnombre" id="txtnombre" class="form-control" placeholder="&#128272; Ingrese Nombre" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                            <div class="col-md-1">
                                <label class="control-label" for="apellido">Apellido</label> 
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="txtapellido" for="apellido" id="txtapellido" class="form-control" placeholder="&#128272; Ingrese Apellido" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                             <div class="col-md-1">
                                <label class="control-label" for="cedula">Cedula</label> 
                            </div>
                            <div class="col-md-2">
                                <input type="number" name="txtcedula" id="txtcedula" class="form-control" placeholder="&#128272; Ingrese Cedula" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                            <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" name="txtdireccion" id="txtdireccion" class="form-control" placeholder="&#128272; Ingrese direccion" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                                 <div class="col-md-1">
                                <label class="control-label" for="telefono">Telefono</label> 
                            </div>
                           <div class="col-md-2">
                                <input type="number" name="txttelefono" id="txttelefono" class="form-control" placeholder="&#128272; Ingrese direccion" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                               <div class="col-md-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="btngrabar" type="button" class="form-control btn-success" value="Grabar" disabled="" onclick="grabarcliente()"/>
                            </div>
                            <div class="col-md-2">
