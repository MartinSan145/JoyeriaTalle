                    ...
                    <form id="formulario" class="form-horizontal" role="form">
                        <div class="form-group">
                           ...
                           <input  type="text" name="txtcodigo" id="txtcodigo" class="form-control" placeholder="&#128272; Autoincrementable" disabled/>
                            ...
                            <div class="col-md-2">
                                <input type="text" name="txtapellido" id="txtapellido" class="form-control" placeholder="&#128272; Ingrese Apellido" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                             <div class="col-md-1">
                        ...
                        <div class="form-group">
                            <div class="col-md-1">
                                <label class="control-label" for="cedula">Direccion</label> 
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="txtdireccion" id="txtdireccion" class="form-control" placeholder="&#128272;" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                            <div class="col-md-1">
                           ...
                           <div class="col-md-3">
                                ...
                                <select class="form-control chosen-select" name="cbocargo" id="cbocargo" disabled="" >
                                    ...
                                    <option value="<%= rscargos.getString("idcargo") %>"><%= rscargos.getString("descripcion") %></option>     
                                  <%
                                        }
                                    %>
                                </select>
                                ...
                                <table class="table table-striped table-bordered" id="grilla">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="warning" hidden="">id cargo</th>
                                            <th class="warning">Cargo</th>
