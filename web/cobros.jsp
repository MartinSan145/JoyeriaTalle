            ...
            <section id="main-content">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!--breadcrumbs end -->
                        <h1 class="h1">Cobros en efectivo</h1>
                    </div>
                </div>
                  <% 
                ...
                <div class="col-md-12">
                    ...
                    <form id="formulario" class="form-horizontal" role="form">
                        <div class="form-group">
                         ...
                         <input type="hidden" value="<%=idapertura%>" class="form-control" value="" name="cboapertura" id="cboapertura" disabled=""/>
                            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-2">
                 <input type="text" value="EFECTIVO" name="cbocobro" id="cbocobro" class="form-control" placeholder="&#128272; " disabled=""/>
                       ...
                       <div class="col-md-1">
                          ...
                          <div class="col-md-2">
                            ...
                            <div class="panel-heading"><strong>Detalles Cobro Efectivo</strong></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        Seleccionar
                                            ...
                                            <input type="hidden" value="<%=idapertura%>"  name="cbocodigo" id="cbocodigo" class="form-control" placeholder="&#128272; " disabled=""/>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                      ...
                                      <table class="table table-inbox" id="grillacobro">
                                    <thead>
                                        <tr class="warning">
                                            <th>Código</th> 
                                            <th>Nro. FActura</th>
