<%-- 
    ...
    Created on : 30-nov-2018, 13:49:41
    Author     : Martin
--%>
...
<html>
            ...
            <div class="container-flat-form">
              ...
              <div class="row">
                  ...
                  <form action="operaciones_bd" method="post" class="form-horizontal">  
                      <div class="form-group">
                          ...
                          <div class="col-md-1">
                            ...
                            <div class="col-md-2">
                                <input type="text" class="form-control" name="txtobservacion" id="txtobservacion"  disabled/>
                            </div>
                          <div class="col-md-1">
               ...
               <select class="form-control chosen-select" name="cboestado" id="cboestado" disabled>
                            ...
                            <option selected value="PROCESADO">PROCESADO</option>
                        </select>
                            ...
                            <div class="form-group">
                            <div class="col-md-1">
                                <label class="control-label" for="cbosucursal">Sucursal</label>
                            </div>
                            <div class="col-md-3">
                                <select class="form-control chosen-select" name="cbosucursal" id="cbosucursal" disabled>
                                    ...
                                    <option value="<%= rsoc.getString("idsucursal")%>"><%= rsoc.getString("descripcion")%></option>     
                             ...
                             <div class="col-md-3">
                                <select class="form-control chosen-select" name="cboempleado" id="cboempleado" disabled>
                                    ...
                                    <option value="<%= rusu.getString("idempleado")%>"><%= rusu.getString("nombre")%></option>     
                            ...
                            <div class="col-md-3">
                                <select class="form-control chosen-select" name="cbodeposito" id="cbodeposito" disabled>
                                    <%
                            ...
                            <div class="panel-heading"><strong>Detalles Pedidos de Compras</strong></div>
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <select class="form-control chosen-select" name="cboproducto" id="cboproducto" disabled onchange="selectproductos();">
                                             <%
                                                ResultSet rsmercaderias = cn.consultar("select * from selectproducto order by idproducto");
                                                while (rsmercaderias.next()) {
                                            %>

                                        <option value="<%= rsmercaderias.getString("idproductos")%>"><%= rsmercaderias.getString("descripcion")%></option> 
                                   ...
                                   <div class="col-md-1">
                                    ...
                                    <div class="col-md-2">
                                        <select class="form-control chosen-select" name="cboproveedor" id="cboproveedor" disabled onchange="selectprov();">
                                             <%
                                                ResultSet rsproveedor = cn.consultar("select * from selectproveedor order by idproveedor");
                                                while (rsproveedor.next()) {
                                            %>

                                        <option value="<%= rsproveedor.getString("idproveedores")%>"><%= rsproveedor.getString("razon_social")%></option> 
    ...
    <script src="js/jquery-1.12.2.min.js"></script> 
       ...
       <script src="pedidos_compra.js"></script> 
    </body>
</html>
