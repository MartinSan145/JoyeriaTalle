...
<!-- Modal -->
    ...
    <section id="container">
                ...
                <ul class="nano-content">
                    ...
                    <li class="sub-menu desactive">
                        ...
                        <a href="javascript:void(0);"><i class="fa fa fa-tasks"></i><span>Referenciales</span>
                            ...
                            <li><a href="cobro_cheque.jsp"><i class=""></i>&nbsp;&nbsp; Cobro Cheque</a></li>
                            <li><a href="cobro_tarjeta.jsp"><i class=""></i>&nbsp;&nbsp; Cobro tarjeta</a></li>
        ...
        <section class="main-content-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li>FACTURAS A COBRAR</li>
                         
                        </ul>
                        <!--breadcrumbs end -->
                        <h1 class="h1">FACTURAS A COBRAR</h1>
                    </div>
                </div>
            ...
            <div class="container-flat-form">
                ...
                bd.conectar();
                int idd;
                ResultSet traerid = bd.combo("select * from facturas_a_cobrar;");
                if(traerid.next()) {
                    idd = traerid.getInt("idfactura_v");
                }
                %>
              <div class="row">
                <div class="col-md-12">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="warning">Nro. Factura</th>
                                             <th class="warning">Fecha de Emision</th>
                                            <th class="warning">Estado de Cuenta</th>
                                            <th class="warning">Caja</th>
                                             <th class="warning">Monto a Cobrar</th>
    ...
    <script src="js/jquery-1.12.2.min.js"></script> 
       ...
       <script src="cuentasacobrar.js"></script> 
    </body>
</html>
