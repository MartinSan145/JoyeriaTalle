                    ...
                    <form id="formulario" class="form-horizontal" role="form">
                        <div class="form-group">
                           ...
                           <input  type="text" name="txtcodigo" id="txtcodigo" class="form-control" placeholder="&#128272; Autoincrementable" disabled/>
                            ...
                            <div class="col-md-2">
                                <input type="text" name="txtdescripcion" id="txtdescripcion" class="form-control" placeholder="&#128272; Ingrese Descripcion" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                            <div class="col-md-1">
                                <label class="control-label" for="precioc">Precio Compra</label> 
                            </div>
                            <div class="col-md-2">
                                <input type="number" name="txtprecioc" for="precioc" id="txtprecioc" class="form-control" placeholder="&#128272; Ingrese Precio Compra" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                             <div class="col-md-1">
                                <label class="control-label" for="preciov">Precio Venta</label> 
                            </div>
                            <div class="col-md-2">
                                <input type="number" name="txtpreciov" id="txtpreciov" class="form-control" placeholder="&#128272; Ingrese Precio Venta" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <label class="control-label" for="tipojoya">Tipo</label> 
                            </div>
                           <div class="col-md-2">
                                <select class="form-control chosen-select" name="cbotipojoya" id="cbotipojoya" disabled="" >
                                    <%
                                    ...
                                    <option value="<%= rstipojoya.getString("idtipo_joya") %>"><%= rstipojoya.getString("descripcion") %></option>     
                                  <%
                                        }
                                    %>
                                </select>
                           ...
                           <div class="col-md-3">
                                <select class="form-control chosen-select" name="cboimpuesti" id="cboimpuesto" disabled="">
                                    <%
                                ...
                                <table class="table table-striped table-bordered" id="grilla">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="warning">Precio C</th>
                                            <th class="warning">Precio V</th>
                                            <th class="warning" hidden="">id tipo joya</th>
                                            <th class="warning">Tipo Joya</th>
                                            <th class="warning" hidden="">id impuesto</th>
