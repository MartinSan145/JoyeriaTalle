                ...
                <div class="col-md-12">
                    ...
                    <form id="formulario" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="txtdescripcion" id="txtdescripcion" class="form-control" placeholder="&#128272; Ingrese descripción" disabled="" onblur="ponerMayuscula()" onchange="sololetras()"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-3"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="btngrabar" type="button" class="form-control btn-success" value="Grabar" disabled="" onclick="grabarciudad()"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="btnreporte" type="button" class="form-control btn-info" value="Reporte"  onclick="crearreporte();"/>
                            </div>
                        </div>
                           <div class="form-group" id="contenedor_grilla">
