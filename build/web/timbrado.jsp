                    ...
                    <form id="formulario" class="form-horizontal" role="form">
                        <div class="form-group">
                           ...
                           <input  type="text" name="txtcodigo" id="txtcodigo" class="form-control" placeholder="&#128272; Autoincrementable" disabled/>
                            ...
                            <div class="col-md-1">
                                <label class="control-label" for="descripcion">Nro</label> 
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <input type="date" class="form-control" name="txtfechav" id="txtfechav" value="<%= Metodo.formatoFecha(new java.util.Date())%>" disabled/>
                            </div>
                                   <div class="col-md-1">
                                ...
                                <table class="table table-striped table-bordered" id="grilla">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="warning">Nro timbrado</th>
                                            <th class="warning">Fecha Vencimiento</th>
