                    ...
                    <form id="formulario" class="form-horizontal" role="form">
                        <div class="form-group">
                          ...
                          <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="txtdescripcion" id="txtdescripcion" class="form-control" placeholder="&#128272; Ingrese descripción" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                        </div>
                            <div class="form-group">
                           <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="txtapellido" id="txtapellido" class="form-control" placeholder="&#128272; Ingrese descripción" disabled="" onblur="ponerMayuscula()"/>
                            </div>
                               <div class="col-md-2">
                                ...
                                <table class="table table-striped table-bordered" id="grilla">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="warning">Nombre Titular</th>
                                            <th class="warning">Apellido Titular</th>
