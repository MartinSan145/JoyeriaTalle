<%-- 
    Document   : orden compra
    Created on : 11-dic-2018, 13:49:41
    Author     : Martin
--%>
            ...
            <div id="leftside-navigation" class="nano">
                <ul class="nano-content">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul>
                  <li><a href="proveedores.jsp"><i class=""></i>&nbsp;&nbsp; Orden de Compra</a></li>
            ...
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="col-md-12">
                  <form action="operaciones_bd" method="post" class="form-horizontal">  
                      <div class="form-group">
                          ...
                          <div class="col-md-1">
                                <label class="control-label" for="orden">Nro Orden</label>
                            </div>
                            <div class="col-md-2">
                                <input type="text" class="form-control" name="txtorden" id="txtorden"  disabled/>
                            </div>
                          <div class="col-md-1">
               ...
               <select class="form-control chosen-select" name="cboestado" id="cboestado" disabled/>
                            ...
                            <div class="col-md-3">
                                <select class="form-control chosen-select" name="cbopedido" id="cbopedido" disabled onchange="selectpedido();">
                                    <option selected="true" value="">
                                        Seleccionar
                                    </option> 
                                    
                                    <%
                                       ResultSet pedido = cn.consultar("select * from pedidoscompras where estado='PENDIENTE';");
                                        while (pedido.next()) {
                                    %>
                            ...
                            <div class="panel-heading"><strong>Detalles Orden de Compra</strong></div>
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <select class="form-control chosen-select" name="cboproducto" id="cboproducto" disabled onchange="selectproducto();">
                                             <%
                                                ResultSet rsmercaderias = cn.consultar("select * from precioscompra order by idproducto");
                                ...
                                <table class="table table-inbox" id="grilla">
                                    <thead>
                                        <tr class="warning">
                                            <th>Código</th> 
                                            <th>Producto</th>
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input id="btngrabar" type="button" class="form-control btn-success" value="Grabar" disabled="" onclick="grabarr();"/>
                            </div>
                            <div class="col-md-2">
